...
export default function AddUNSanctionsListModal({
  isOpen,
  setIsOpen,
  onRecordAdded,
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiRequest.post("/un-sanctions-list", data);
      console.log("UN Sanctions List Added: ", response.data);
