...
export default function EditPSPScheduleOfSystemStabilityInterruptionModal({
  isOpen,
  setIsOpen,
  sysStability,
  onRecordAdded,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiRequest.put(
        `/psp-schedule-of-system-stability-and-service-interruption/${sysStability.rowId}`,
        data
      );
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Edit Schedule Of System Stability & System Interruption
                  </Dialog.Title>
                    ...
                    <div className="flex flex-wrap gap-4 items-center justify-between">
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          id="thirdPartyName"
                          required
                          defaultValue={sysStability.thirdPartyName}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          defaultValue={sysStability.thirdPartySystemAffected}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          name="systemUptime"
                          id="systemUptime"
                          defaultValue={sysStability.systemUptime}
                          min={0}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
