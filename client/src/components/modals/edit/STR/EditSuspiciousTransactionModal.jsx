...
export default function EditSuspiciousTransactionModal({
  isOpen,
  setIsOpen,
  transaction,
  onRecordAdded,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiRequest.put(
        `/suspicious-transactions/${transaction.rowId}`,
        data
      );
      console.log("Suspicious Transaction Updated: ", response.data);
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Edit Suspicious Transaction Record
                  </Dialog.Title>
                    ...
                    <div className="flex flex-wrap gap-4 items-center justify-between">
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <select
                          ...
                          id="pspId"
                          required
                          defaultValue={transaction.pspId}
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          id="reportingDate"
                          required
                          defaultValue={transaction.reportingDate}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <select
                          ...
                          id="transactionFlag"
                          required
                          defaultValue={transaction.transactionFlag}
                          className="outline-none border p-1.5 rounded"
                        >
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          required
                          defaultValue={transaction.numberOfMLRelatedSTRsReported}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          required
                          defaultValue={transaction.numberOfTFRelatedSTRsReported}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          required
                          defaultValue={transaction.numberOfPFRelatedSTRsReported}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          required
                          defaultValue={transaction.numberOfTransactionsAbove15000}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                      ...
                      <div className="flex flex-col gap-1 w-56">
                        ...
                        <input
                          ...
                          required
                          defaultValue={transaction.totalValueOfTransactionsAbove15000}
                          className="outline-none border p-1.5 rounded"
                        />
                      </div>
                    </div>
