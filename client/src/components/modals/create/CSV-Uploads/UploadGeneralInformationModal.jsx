...
export default function UploadGeneralInformationModal({
  isOpen,
  setIsOpen,
  onRecordAdded,
}) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await apiRequest.post(
        "/general-information/upload-csv",
        formData,
        {
          headers: {
            ...
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-6xl transform overflow-hidden rounded-2xl bg-white p-6 text-left align-middle shadow-xl transition-all">
                  ...
                  >
                    Upload General Information CSV
                  </Dialog.Title>
                  <form
                    className="mt-3"
                  ...
                  >
                    <div className="mb-4">
                      ...
                      <p className="mt-2 text-xs text-gray-500">
                        CSV file must include columns: PSP_ID, REPORTING_DATE,
                        TOTAL_NUMBER_OF_STAFF, COMPLIANCE_STAFF_AML_TF_PF
                      </p>
                    </div>
                    <div className="mt-4">
                      <button
